...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { end_date: @rent.end_date, notes: @rent.notes, start_date: @rent.start_date }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { end_date: @rent.end_date, notes: @rent.notes, start_date: @rent.start_date }
    assert_redirected_to rent_path(assigns(:rent))
  end
